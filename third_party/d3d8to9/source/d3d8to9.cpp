...
extern "C" HRESULT WINAPI TranslatedValidatePixelShader(const DWORD* pPixelShader, const D3DCAPS8* pCaps, BOOL ReturnErrors, char** pErrorsString)
{
#ifndef D3D8TO9NOLOG
...
extern "C" HRESULT WINAPI TranslatedValidateVertexShader(const DWORD* pVertexShader, const DWORD* pVertexDecl, const D3DCAPS8* pCaps, BOOL ReturnErrors, char** pErrorsString)
{
...
extern "C" void WINAPI TranslatedDebugSetMute()
{
#ifndef D3D8TO9NOLOG
...
extern "C" IDirect3D8 *WINAPI CreateTranslatedD3D8(UINT SDKVersion)
{
	...
	{
		const HMODULE module = LoadLibraryExW(L"d3dx9_43.dll", nullptr, LOAD_LIBRARY_SEARCH_SYSTEM32);
