...
cl /source-charset:gbk /execution-charset:gbk /O2 /MD /EHsc /std:c++17 /D WIN32 /D NDEBUG /D _WINDOWS /D _USRDLL /D EZORSIA_EXPORTS /D _CRT_SECURE_NO_WARNINGS /I. /I..\detours *.cpp /link /DLL /MACHINE:X86 /LIBPATH:..\detours detours.lib imm32.lib ws2_32.lib user32.lib gdi32.lib advapi32.lib ole32.lib oleaut32.lib /OUT:ijl15.dll
